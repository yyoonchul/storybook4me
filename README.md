...
2) Characters: add your family or pull from preset Storybook4me friends.  
3) Studio: set concept → pick art style → generate → preview/edit pages → ask AI to rewrite or answer questions.  
4) Library: manage your bookshelf, switch public/private, or delete.  
5) Explore: search/sort community stories by category, popularity, or recency.

## Features at a glance
- Prompt-to-story generator with 14 spreads and live preview.
- Character builder with editable avatars and preset cast.
- AI Studio co-pilot: rewrite the full script or answer questions about your draft.
